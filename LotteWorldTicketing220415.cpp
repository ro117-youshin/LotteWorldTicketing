...
int main() {
   ...
   // 출력 
   	...
   	for (int index = 0; index < orderCount; index++) {
    	...
    	printf("\n");
//    	printf("%d %d %d %2d %d원 %d", orderList[index][0], orderList[index][1], orderList[index][2], orderList[index][3], orderList[index][4], orderList[index][5]);
   }
}
